...
<div class="right">
        ...
        <div class="providerAdd">
           <form  method="post" action="providerAdd.do" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label for="a_companyLicPicPath">企业营业执照：</label>
                   	<input type="file" name="rolecphoto" id="a_companyLicPicPath"/>
                    <font color="red"></font>
                </div>
                 <div>
                	
                    <label for="a_orgCodePicPath">组织机构代码证：</label>
                   	<input type="file" name=rolewphoto id="a_orgCodePicPath"/>
                    <font color="red"></font>
                </div>
